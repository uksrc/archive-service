...
INSERT INTO "TAP_SCHEMA"."columns" VALUES ('TAP_SCHEMA.schemas', 'schema_index', 'To allow ordered display if required.', NULL, NULL, NULL, 'VARCHAR', -1, 0, 0, 1, NULL);
...
INSERT INTO "TAP_SCHEMA"."columns" VALUES ('TAP_SCHEMA.tables', 'table_index', 'To allow ordered display if required.', NULL, NULL, NULL, 'VARCHAR', -1, 0, 0, 1, NULL);
...
INSERT INTO "TAP_SCHEMA"."columns" VALUES ('TAP_SCHEMA.columns', 'arraysize', 'arraysize, * for varying or NULL for none', NULL, NULL, NULL, 'VARCHAR', -1, 0, 0, 1, NULL);
INSERT INTO "TAP_SCHEMA"."columns" VALUES ('TAP_SCHEMA.columns', 'xtype', 'custom type specification, consider utype instead', NULL, NULL, NULL, 'VARCHAR', -1, 0, 0, 1, NULL);
...
INSERT INTO "TAP_SCHEMA"."columns" VALUES ('TAP_SCHEMA.columns', 'column_index', 'To allow ordered display if required.', NULL, NULL, NULL, 'VARCHAR', -1, 0, 0, 1, NULL);
